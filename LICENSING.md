...
A `LICENSE-prefect` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [PrefectHQ/prefect](https://github.com/PrefectHQ/prefect), Copyright
2019- Prefect Technologies, Inc, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../prefect-port/specs/SPEC-001-prefect.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
